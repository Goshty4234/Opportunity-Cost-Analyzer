...
function OpportunityCostCalculator() {
  ...
  const calculateFutureValue = (option) => {
    ...
    for (let year = startYear + 1; year <= (years || 0); year++) {
      ...
      // Salary is invested progressively throughout the year, so average time invested is 0.5 years less
  ...
  const generateYearlyCashFlowWithInterest = (option) => {
    ...
    for (let year = 1; year <= years; year++) {
      ...
      if (year <= (option.tuitionYears || 0)) {
        ...
        const yearsWorked = Math.max(0, year - startYear - 1)
        cashFlowThisYear += (option.initialSalary || 0) * Math.pow(1 + salaryGrowth, yearsWorked)
      }
      ...
      <div className="settings-card">
        ...
        <div style={{ 
          ...
          <p style={{ margin: '8px 0 0 0', lineHeight: '1.6' }}>
            <strong>Positive Money (Investments):</strong> Money received during a year earns <strong>50% of the interest rate</strong> in the first year 
